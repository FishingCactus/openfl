...
class DrawCommandReader {
	...
	private function advance ():Void {
		...
		switch (prev) {
			...
			case DRAW_ARC:
				...
				fPos += 5; //x, y, radius, startAngle, endAngle
	...
	public inline function readDrawArc ():DrawArcView { advance (); prev = DRAW_ARC; return new DrawArcView (this); }
...
abstract DrawArcView (DrawCommandReader) {

	public inline function new (d:DrawCommandReader) { this = d; }
	public var x (get, never):Float; private inline function get_x ():Float { return this.float (0); }
	public var y (get, never):Float; private inline function get_y ():Float { return this.float (1); }
	public var radius(get, never):Float; private inline function get_radius ():Float { return this.float (2); }
	public var startAngle(get, never):Float; private inline function get_startAngle ():Float { return this.float (3); }
	public var endAngle(get, never):Float; private inline function get_endAngle ():Float { return this.float (4); }
